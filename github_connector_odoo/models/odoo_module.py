...
class OdooModule(models.Model):
    ...
    serie_ids = fields.Many2many(
        ...
        compute='_compute_serie', store=True,
        relation='github_module_serie_rel',
        column1='module_id', column2='serie_id')

    serie_ids_description = fields.Char(
        string='Series (Text)', store=True,
        compute='_compute_serie')
    ...
    @api.multi
    @api.depends('module_version_ids.serie_id')
